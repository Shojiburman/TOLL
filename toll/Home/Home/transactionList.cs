    ...
    public partial class transactionList : Form
    {
        ...
        public transactionList()
        {
            ...
            try
            {
                ...
                if (admin == 0)
                {
                    SqlCommand command1 = new SqlCommand("select place, price, [Vehicle Number] from [Transaction] where Username ='" + Program.userName + "'", con);   //Generating SQL Query
                    ...
                    else
                    {
                        ...
                        transactionListdgv.DataSource = source;  //Binding gridview or control datacsource to binding source:
                    }
                }
                else
                {
                    SqlCommand command2 = new SqlCommand("select place, price, [Vehicle Number], Username from [Transaction]", con);   //Generating SQL Query
